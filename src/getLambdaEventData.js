...
getUserId = function(record, next) {
    var UserId = (record.dynamodb.NewImage.Email.M.UserId.N) ? record.dynamodb.NewImage.Email.M.UserId.N : '';
...
getBulkEmailTimestamp = function(record, next) {
    var BulkEmailTimestamp = (record.dynamodb.NewImage.BulkEmailTimestamp.N) ? record.dynamodb.NewImage.BulkEmailTimestamp.N : '';
...
module.exports = {
    ...
    getBulkEmailTimestamp:getBulkEmailTimestamp
};
